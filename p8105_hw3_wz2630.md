...
The spaghetti plots of these “Excellent” ratings across all states shows
that there is great variance and is difficult to identify a trend.
However, it is shown that there is a dense overlap of data values from
20-24. There is no notable difference in this observation across the
years(2002-2010).
...
in 2010. The median for”Very good” had a noticle increase from 2006 to
2010.
...
This category also has the largest age range.
...
activity across all 3 education levels. There is a decreased amount of
physical activity in a day as age increases. The “less than high school”
education level has overall more physical activity. Females tend to have
more physical activity for both “high school equivalent” and “more than
